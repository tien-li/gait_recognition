...
import pandas as pd
df = pd.read_excel('/Users/ken/Desktop/專題/20200428/experiment_data0428/林天立_xlsx/run.xlsx',sheet_name='left')
...
F = DataFrame(final)
F.to_excel('/Users/ken/Desktop/專題/20200428/experiment_data0428/林天立_output/run_left.xlsx')
print('Finish')