...
import pandas as pd
df = pd.read_excel('/Users/ken/Desktop/專題/20200428/experiment_data0428/林天立_xlsx/Constrain_weight.xlsx',sheet_name='right')
...
F = DataFrame(final)
F.to_excel('/Users/ken/Desktop/專題/20200428/experiment_data0428/林天立_output/Constrain_weight_right.xlsx')
print('Finish')