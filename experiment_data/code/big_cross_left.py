...
import pandas as pd
df = pd.read_excel('/Users/ken/Desktop/專題/20200428/experiment_data0428/林天立_xlsx/8+9.xlsx',sheet_name='left')
...
F = DataFrame(final)
F.to_excel('/Users/ken/Desktop/專題/20200428/experiment_data0428/林天立_output/8+9_left.xlsx')
print('Finish')